...
Definitions:
EBook
Text format compatible with EPUB3 (see if it compensates for HTML) which contains:
...
Contributions here justify the name Ampersand. The author works as a snap, a conversation starter, which doesn't even need to be central. A reader's work can even surpass the original (as in fanfic or in collaborative books/blogs like “The Martian”, which don't keep all the glory for the author).

Among the contributions of readers/collaborators are:
...
Marginália - the annotations in the margins of a book concentrate, for me, the highest point of the author's relationship with his audience, to the point where he cannot contain himself and need to register there, in the body of the book, his opinion and/or additional comment . It's a very rich moment that needs to be shared. Even those who take notes tend to be surprised by their impact when rereading them.
...
●   Dimensionality - a segment can be tiny or huge, and vary immensely

●   Linearity - like ideas that form, a topic can start from any point
...
Informative landscape [^1] - the idea is to present a content block as an address in an urban landscape, which can be visited in different degrees of interaction and depth, depending on the vehicle used.
